...
fn expected_paths_simple_stuttgart(
    ...
    vec![
        ...
        (
            opp,
            stu,
            Some((Meters::new(48_000), vec![vec![opp, bac, wai, stu]])),
        ),
        // bac
        (bac, opp, Some((Meters::new(8_000), vec![vec![bac, opp]]))),
        (bac, bac, Some((Meters::new(0), vec![vec![]]))),
        ...
        (dea, wai, None),
        (dea, end, None),
        (dea, dea, Some((Meters::new(0), vec![vec![]]))),
        (dea, stu, None),
        // stu
        (
            stu,
        ...
        (
            stu,
            dea,
            Some((Meters::new(41_069), vec![vec![stu, wai, bac, dea]])),
        ),
        (stu, stu, Some((Meters::new(0), vec![vec![]]))),
    ]
}
...
fn expected_paths_small() -> Vec<(TestNode, TestNode, Option<(Meters, Vec<Vec<TestNode>>)>)> {
    ...
    vec![
        ...
        (a, h, None),
        // b
        (b, a, Some((Meters::new(1), vec![vec![b, a]]))),
        (b, b, Some((Meters::new(0), vec![vec![]]))),
        (b, c, Some((Meters::new(1), vec![vec![b, c]]))),
        (b, d, None),
        (b, e, None),
        (b, f, None),
        (b, g, None),
        (b, h, None),
        // c
        (c, a, Some((Meters::new(1), vec![vec![c, a]]))),
        (c, b, Some((Meters::new(1), vec![vec![c, b]]))),
        (c, c, Some((Meters::new(0), vec![vec![]]))),
        (c, d, None),
        (c, e, None),
        (c, f, None),
        (c, g, None),
        (c, h, None),
        // d
        (d, a, Some((Meters::new(2), vec![vec![d, b, a]]))),
        (d, b, Some((Meters::new(1), vec![vec![d, b]]))),
        (d, c, Some((Meters::new(2), vec![vec![d, b, c]]))),
        (d, d, Some((Meters::new(0), vec![vec![]]))),
        (d, e, Some((Meters::new(2), vec![vec![d, e]]))),
        (d, f, Some((Meters::new(2), vec![vec![d, h, f]]))),
        (d, g, None),
        (d, h, Some((Meters::new(1), vec![vec![d, h]]))),
        // e
        (e, a, Some((Meters::new(4), vec![vec![e, d, b, a]]))),
        (e, b, Some((Meters::new(3), vec![vec![e, d, b]]))),
        (e, c, Some((Meters::new(4), vec![vec![e, d, b, c]]))),
        (e, d, Some((Meters::new(2), vec![vec![e, d]]))),
        (e, e, Some((Meters::new(0), vec![vec![]]))),
        (e, f, Some((Meters::new(1), vec![vec![e, f]]))),
        (e, g, None),
        (e, h, Some((Meters::new(2), vec![vec![e, f, h]]))),
        // f
        (f, a, Some((Meters::new(4), vec![vec![f, h, d, b, a]]))),
        (f, b, Some((Meters::new(3), vec![vec![f, h, d, b]]))),
        (f, c, Some((Meters::new(4), vec![vec![f, h, d, b, c]]))),
        (f, d, Some((Meters::new(2), vec![vec![f, h, d]]))),
        (f, e, Some((Meters::new(1), vec![vec![f, e]]))),
        (f, f, Some((Meters::new(0), vec![vec![]]))),
        (f, g, None),
        (f, h, Some((Meters::new(1), vec![vec![f, h]]))),
        // g
        (g, a, Some((Meters::new(5), vec![vec![g, e, d, b, a]]))),
        (
            g,
            b,
        ...
        (g, h, Some((Meters::new(2), vec![vec![g, f, h]]))),
        // h
        (h, a, Some((Meters::new(3), vec![vec![h, d, b, a]]))),
        (h, b, Some((Meters::new(2), vec![vec![h, d, b]]))),
        (h, c, Some((Meters::new(3), vec![vec![h, d, b, c]]))),
        (h, d, Some((Meters::new(1), vec![vec![h, d]]))),
        (h, e, Some((Meters::new(2), vec![vec![h, f, e]]))),
        (h, f, Some((Meters::new(1), vec![vec![h, f]]))),
        (h, g, None),
        (h, h, Some((Meters::new(0), vec![vec![]]))),
    ]
}
...
fn expected_paths_bait() -> Vec<(TestNode, TestNode, Option<(Meters, Vec<Vec<TestNode>>)>)> {
    ...
    vec![
        // ll
        (ll, ll, Some((Meters::new(0), vec![vec![]]))),
        (ll, bb, Some((Meters::new(5), vec![vec![ll, bb]]))),
        (ll, rr, Some((Meters::new(9), vec![vec![ll, tl, tr, rr]]))),
        (ll, tr, Some((Meters::new(6), vec![vec![ll, tl, tr]]))),
        (ll, tl, Some((Meters::new(3), vec![vec![ll, tl]]))),
        // bb
        (bb, ll, Some((Meters::new(5), vec![vec![bb, ll]]))),
        (bb, bb, Some((Meters::new(0), vec![vec![]]))),
        (bb, rr, Some((Meters::new(5), vec![vec![bb, rr]]))),
        (bb, tr, Some((Meters::new(8), vec![vec![bb, rr, tr]]))),
        (bb, tl, Some((Meters::new(8), vec![vec![bb, ll, tl]]))),
        // rr
        (rr, ll, Some((Meters::new(9), vec![vec![rr, tr, tl, ll]]))),
        (rr, bb, Some((Meters::new(5), vec![vec![rr, bb]]))),
        (rr, rr, Some((Meters::new(0), vec![vec![]]))),
        (rr, tr, Some((Meters::new(3), vec![vec![rr, tr]]))),
        (rr, tl, Some((Meters::new(6), vec![vec![rr, tr, tl]]))),
        // tr
        (tr, ll, Some((Meters::new(6), vec![vec![tr, tl, ll]]))),
        (tr, bb, Some((Meters::new(8), vec![vec![tr, rr, bb]]))),
        (tr, rr, Some((Meters::new(3), vec![vec![tr, rr]]))),
        (tr, tr, Some((Meters::new(0), vec![vec![]]))),
        (tr, tl, Some((Meters::new(3), vec![vec![tr, tl]]))),
        // tl
        (tl, ll, Some((Meters::new(3), vec![vec![tl, ll]]))),
        (tl, bb, Some((Meters::new(8), vec![vec![tl, ll, bb]]))),
        (tl, rr, Some((Meters::new(6), vec![vec![tl, tr, rr]]))),
        (tl, tr, Some((Meters::new(3), vec![vec![tl, tr]]))),
        (tl, tl, Some((Meters::new(0), vec![vec![]]))),
    ]
}
